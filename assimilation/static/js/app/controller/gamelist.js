goog.provide('assimilation.GameList');

/**
*
* @constructor
*/
assimilation.GameList = function(userid){
	this.userid = userid;
...
assimilation.GameList.prototype.update = function() {
	var me = this;
...
assimilation.GameList.prototype.addGame = function(game) {
